/**
 * lib/ipc/message_store.h - Message persistence for inter-agent communication
 *
 * Provides SQLite-backed storage for direct messages and pub/sub channels.
 * Part of the IPC module in lib/.
 */
